...
import { r as requireTr46 } from "../_chunks/_libs/tr46.mjs";
var publicApi = {};
var URL = { exports: {} };
var utils = { exports: {} };
...
function requireUrlStateMachine() {
  ...
  (function(module) {
    ...
    const tr46 = /* @__PURE__ */ requireTr46();
...
function requireURLImpl() {
  ...
  const usm = /* @__PURE__ */ requireUrlStateMachine();
...
function requireURL() {
  ...
  hasRequiredURL = 1;
  (function(module) {
    const conversions = /* @__PURE__ */ requireLib();
    const utils2 = /* @__PURE__ */ requireUtils();
    const Impl = /* @__PURE__ */ requireURLImpl();
...
var publicApiExports = /* @__PURE__ */ requirePublicApi();
